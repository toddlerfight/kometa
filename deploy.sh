...
NAS_SSH="ssh -p $NAS_PORT -i ~/.ssh/id_ed25519 <nas-user>@$NAS_HOST"
...
$NAS_SSH "
  ...
  $DOCKER exec gitea git -C /tmp/kometa_repo pull 2>/dev/null || \
    $DOCKER exec gitea git clone http://<nas-user>:046ee22b21efc43fd55fe93e1e4b99a460245cee@localhost:3000/<nas-user>/kometa.git /tmp/kometa_repo
